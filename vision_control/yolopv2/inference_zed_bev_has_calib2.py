...
def make_parser():
    ...
    parser.add_argument('--calibrate', action='store_true', help='enable ROI calibration and save to ROI.txt (use without value, e.g., --calibrate)')
    return parser
...
def detect():
    ...
    try:
        while True:
            ...
            ll_seg_mask_transformed = np.zeros_like(da_seg_mask_transformed)
