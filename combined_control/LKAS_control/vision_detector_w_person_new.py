...
class NetworkManager:
    def __init__(self):
        ...
        self.mode_socket = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)  # New socket for mode
        ...
        self.mode_address = ('localhost', 12360)  # Address for mode socket
    ...
    def send_mode(self, mode):
        try:
            mode_bytes = struct.pack('i', mode)  # Pack mode as integer
    ...
    def cleanup(self):
        ...
        self.mode_socket.close()  # Close mode socket
...
def detect():
    ...
    waypoint_extractor = WaypointExtractor(num_points=5)
    ...
    # Set default mode to ACC (0) and send it
    mode = 0  # 0: ACC, 1: AEB, 2: LKAS
